...
<template>
  <div class="min-h-screen bg-ink-50 dark:bg-ink-950 flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
      ...
      <div class="bg-white rounded-2xl border border-ink-100 shadow-sm p-8 relative overflow-hidden dark:bg-ink-900 dark:border-ink-800">
        <!-- Progress bar -->
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          <div>
            <label class="block text-sm font-ui font-medium text-ink-700 dark:text-ink-300 mb-1.5">Name</label>
            <input
              v-model="name"
              type="text"
              required
